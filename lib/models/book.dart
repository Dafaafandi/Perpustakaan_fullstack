...
class Book {
  ...
  // Getter untuk membuat URL gambar yang lengkap
  String? get coverUrl {
    if (path != null && path!.isNotEmpty) {
      // API Anda sepertinya menyimpan gambar di root domain, bukan di dalam /api
      return 'http://perpus-api.mamorasoft.com/$path';
    }
    return null;
  }
